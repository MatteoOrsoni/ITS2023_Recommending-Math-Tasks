...
path = 'Your path here'
setwd(path)
Data <- read_excel("Vektorraeume_db_v2.xlsx")
str(Data)
Data = Data[-13]
...
difficulty_db = data.frame(difficulty_rasch[1], difficulty_rasch[2], difficulty_rasch[3], difficulty_rasch[4],
                           difficulty_rasch[5],difficulty_rasch[6],difficulty_rasch[7],difficulty_rasch[8],
                           difficulty_rasch[9],difficulty_rasch[10],difficulty_rasch[11],difficulty_rasch[12],
                           3, difficulty_rasch[13])
colnames(difficulty_db) <- c('Item_1', 'Item_2','Item_3','Item_4', 'Item_5', 'Item_6','Item_7','Item_8',
                             'Item_9', 'Item_10','Item_11','Item_12', 'Item_13', 'Item_14')
rownames(difficulty_db) <- 'difficulty_test'


View(difficulty_db)

write.csv(difficulty_db, 'Difficulty_Vektorraeume.csv')
