...
path = 'Your path here'
setwd(path)
Data <- read_excel("KomplexeZahlen_DefWerteBereich_db_v2.xlsx")
str(Data)
...
difficulty_db = data.frame(difficulty_rasch[1], difficulty_rasch[2], difficulty_rasch[3], difficulty_rasch[4], difficulty_rasch[5],
                           difficulty_rasch[6], difficulty_rasch[7], difficulty_rasch[8])
...
write.csv(difficulty_db, 'Difficulty_KomplexeZahlen.csv')
