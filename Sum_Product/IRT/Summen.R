...
path = 'Your path here'
setwd(path)
Data <- read_excel("Summen_db_v2.xlsx")
str(Data)
...
anova(mirt_Rasch, mirt_two_PL_0)
...
difficulty_db = data.frame(difficulty_rasch[1], difficulty_rasch[2], difficulty_rasch[3], -4)
...
write.csv(difficulty_db, 'Difficulty_Summen.csv')
