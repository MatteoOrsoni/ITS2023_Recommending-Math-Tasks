...
path = 'Your path here'
setwd(path)
Data <- read_excel("Gleichungssysteme_db_v2.xlsx")
str(Data)
...
difficulty_db = data.frame(difficulty_0[1], difficulty_0[2], difficulty_0[3], difficulty_0[4], difficulty_0[5],
                           difficulty_0[6], difficulty_0[7], difficulty_0[8], difficulty_0[9], difficulty_0[10])
...
write.csv(difficulty_db, 'Difficulty_Gleichungssysteme.csv')
